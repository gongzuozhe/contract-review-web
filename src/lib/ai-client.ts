...
const MODELS: Record<string, Record<string, string>> = {
  ...
  zhipu: { 'glm-4-flash': 'glm-4-flash', 'glm-4': 'glm-4', 'glm-4-plus': 'glm-4-plus', 'glm-4-vision-flash': 'glm-4-vision-flash', 'glm-4.7-flash': 'glm-4.7-flash', 'glm-3-turbo': 'glm-3-turbo' },
